    ...
    <Layout>
      <div className="project-detail-container">
        ...
        <div className="project-header">
          ...
          <div className="project-description">
            ...
            <ul>
              ...
              <li><strong>{t('fotiou.school')}</strong> 350 meters</li>
              <li><strong>{t('fotiou.university')}</strong> 2.3 km</li>
            </ul>
            ...
            <p><strong>{t('fotiou.cta')}</strong></p>
          </div>
        </div>
        ...
        <div className="project-stats">
          {[
            { icon: '/images/m2-icon.png', value: '75', label: 'Ground (m²)' },
            { icon: '/images/parking-icon.png', value: '3', label: 'Car parkings' },
            { icon: '/images/floor-icon.png', value: '6', label: 'Floors' },
            { icon: '/images/storage-icon.png', value: '6', label: 'Storage Rooms' },
          ].map((item, index) => (
