...
const Pirinis = () => {
  ...
  return (
    <>
      ...
      <Title>Priinis 6 Project | Rain Construction</Title>
      <Meta
        name="description"
        content="Priinis 6 residential building project by Rain Construction in Athens, featuring modern construction standards, parking spaces and strong investment potential."
      />
      <HeadLink
        rel="canonical"
        href="https://rainconstructiongr.com/projects/priinis-6"
      />
        ...
        <div className="project-detail-container">
          <div className="project-header">
            ...
            <div className="project-description">
              ...
              <p>
                <strong>{t("pirinis.callToAction")}</strong>
              </p>
            </div>
          </div>
            ...
            {[
              {
                ...
                value: "95",
                label: t("pirinis.stats.ground"),
              },
              {
                icon: "/images/parking-icon.png",
                value: "3",
                label: t("pirinis.stats.parking"),
              },
              {
                icon: "/images/floor-icon.png",
                value: "6",
                label: t("pirinis.stats.floors"),
              },
              {
                icon: "/images/storage-icon.png",
                value: "6",
                label: t("pirinis.stats.storage"),
              },
            ].map((item, index) => (
